...
void hooked_events::fire_game_event(i_game_event* event) noexcept {
...
int hooked_events::get_event_debug_id(void) noexcept {
	return EVENT_DEBUG_ID_INIT;
}

void hooked_events::setup() noexcept {
...
void hooked_events::release() noexcept {
