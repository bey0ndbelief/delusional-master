...
for (var deathnotice of $.GetContextPanel().FindChildrenWithClassTraverse('DeathNotice'))
{
	// ---------------- ICON REMOVALS ----------------
	...
	deathnotice.FindChildTraverse('HeadShot').SetImage('https://cdn.discordapp.com/attachments/1020523043187069049/1020523820743921695/deathnoticehs.png')
	deathnotice.FindChildTraverse('Penetrate').SetImage('https://cdn.discordapp.com/attachments/1020523043187069049/1020523819355615292/deathnoticepenetrate.png')
	deathnotice.FindChildTraverse('Suicide').SetImage('https://cdn.discordapp.com/attachments/1020523043187069049/1020523819816980570/deathnoticesuicide.png')
	...
	var HudDeathNotice = $.GetContextPanel().FindChildTraverse('HudDeathNotice')
	HudDeathNotice.style.paddingRight = '5px'
	
	if(deathnotice.BHasClass('DeathNotice_Killer'))
	for (var killer of $.GetContextPanel().FindChildTraverse('HudDeathNotice').FindChildrenWithClassTraverse('DeathNotice_Killer'))
		{
		for(var bg of killer.FindChildrenWithClassTraverse('DeathNoticeBGBorder'))
			{
					killer.style.backgroundImage = 'url("https://cdn.discordapp.com/attachments/1020523043187069049/1020523818965553212/deathnoticekillerborder.png")';
					killer.style.backgroundSize = '100% 100%'
			}
			for(var content of killer.FindChildrenWithClassTraverse('DeathNoticeContent'))
			{
				content.style.transitionDelay = '5.0s';
				content.style.S2MixBlendMode = 'normal';
			}
			
			for(var dnBackgroundg of killer.FindChildrenWithClassTraverse('DeathNoticeBG'))
			{
				dnBackgroundg.style.opacity = '0';
			}
		}
	}
	if(deathnotice.BHasClass('DeathNotice_Victim'))
	{
		for (var victim of $.GetContextPanel().FindChildTraverse('HudDeathNotice').FindChildrenWithClassTraverse('DeathNotice_Victim'))
		{
			victim.style.backgroundImage = 'url("https://cdn.discordapp.com/attachments/1020523043187069049/1020523820160925766/Deathborder.png")';
			victim.style.boxShadow = 'inset #e1000000 0px 0px 0px;';
			victim.style.backgroundColor = '#00000000'
		}
		for(var content of victim.FindChildrenWithClassTraverse('DeathNoticeContent'))
		{
			content.style.transitionDelay = '5.0s';
			content.style.boxShadow = 'inset #e1000000 0px 0px 0px;';
			content.style.backgroundColor = '#00000000'
		}
		for(var dnBackgroundg of victim.FindChildrenWithClassTraverse('DeathNoticeBG'))
			{
				dnBackgroundg.style.opacity = '0';
				dnBackgroundg.style.boxShadow = 'inset #e1000000 0px 0px 0px;';
				dnBackgroundg.style.backgroundColor = '#00000000'
			}
	}
for (var dnBackground of $.GetContextPanel().FindChildrenWithClassTraverse('DeathNoticeBGBorder'))
{
...
for (var dnBackground of $.GetContextPanel().FindChildrenWithClassTraverse('DeathNoticeContent'))
{
	
	// dnBackground.style.transitionDuration = '0.0s';
	   dnBackground.style.y = '-2px'
	   dnBackground.style.boxShadow = 'inset #e1000000 0px 0px 0px;';
}
for (var dnBackgroundg of $.GetContextPanel().FindChildrenWithClassTraverse('DeathNoticeBG'))
{
	dnBackgroundg.style.backgroundImage = 'url("https://cdn.discordapp.com/attachments/1020523043187069049/1020523820441935902/deathnoticegradient.png")';
...
{
	dnT.style.color = '#dcb34f';
	dnT.style.fontSize = '22px';
	dnT.style.marginLeft = '2px;'
	dnT.style.marginRight = '2px;'
	dnT.style.textShadowFast = '0px 0px 0px #00000000'
	dnT.style.boxShadow = 'inset #e1000000 0px 0px 0px;';
	dnT.style.S2MixBlendMode = 'SRGBadditive'
	dnT.style.opacity = '1'
	dnT.style.transform = 'translateY(2px)';
	dnT.style.zIndex = '50'
}
for (var dnCT of $.GetContextPanel().FindChildrenWithClassTraverse('DeathNoticeCTColor'))
{
	dnCT.style.color = '#6993d9';
	dnCT.style.fontSize = '22px';
	dnCT.style.marginLeft = '2px;'
	dnCT.style.marginRight = '2px;'
	dnCT.style.textShadowFast = '0px 0px 0px #00000000'
	dnCT.style.boxShadow = 'inset #e1000000 0px 0px 0px;';
	dnCT.style.S2MixBlendMode = 'SRGBadditive'
	dnCT.style.opacity = '1'
	dnCT.style.transform = 'translateY(2px)';
	dnCT.style.zIndex = '50'
		}
	}

$.Schedule(0.001, deathnotice);
//deathnotice();
)";
