...
namespace c {
	...
	void save(const std::size_t index) {
		...
		write_value(json[xs("menu")][xs("menu_accent2[0]")], menu::menu_accent2[0]);
		write_value(json[xs("menu")][xs("menu_accent2[1]")], menu::menu_accent2[1]);
		write_value(json[xs("menu")][xs("menu_accent2[2]")], menu::menu_accent2[2]);
		...
		write_value(json[xs("misc")][xs("chat_print_clr")], misc::chat_print_clr);
		...
		write_value(json[xs("misc")][xs("movement_rec_maxrender")], misc::movement_rec_maxrender);
	...
	void load(const std::size_t index) {
		...
		if (std::ifstream input_file{ path }; input_file.good()) {
			...
			read_value(json[xs("menu")][xs("menu_accent2[0]")], menu::menu_accent2[0]);
			read_value(json[xs("menu")][xs("menu_accent2[1]")], menu::menu_accent2[1]);
			read_value(json[xs("menu")][xs("menu_accent2[2]")], menu::menu_accent2[2]);
			...
			read_value(json[xs("misc")][xs("chat_print_clr")], misc::chat_print_clr);
			...
			read_value(json[xs("misc")][xs("movement_rec_maxrender")], misc::movement_rec_maxrender);
