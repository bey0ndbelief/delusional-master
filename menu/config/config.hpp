...
namespace c {
	...
	namespace movement {
		...
		inline bool edge_bug_rage = false;
		inline int edge_bug_priority = 0;
		inline int edge_bug_key = 0;
		inline int edge_bug_key_s = 1;
		inline float edge_bug_ticks = 0.f;
		inline float edge_bug_lock_amount = 0.f;
		...
		inline int pixel_surf_ticks = 10;
	...
	namespace misc {
		...
		inline int movement_rec_maxrender = 0;
