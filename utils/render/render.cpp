...
void surface::initialize() {
	...
	interfaces::surface->set_font_glyph(surface::fonts::watermark, ("Small Fonts"), 9, 100, 0, 0, font_flags::fontflag_dropshadow);
	interfaces::surface->set_font_glyph(surface::fonts::esp, ("Tahoma"), 12, 700, 0, 0, font_flags::fontflag_dropshadow);
}
